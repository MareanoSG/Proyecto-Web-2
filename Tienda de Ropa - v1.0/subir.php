...
<head>
    ...
    <link rel="stylesheet" href="CSS/stSubir.css">
    ...
    <section class="subirPrenda">
        ...
        if (isset($_POST['registrar'])) {
            ...
            if (move_uploaded_file($imagen_tmp, $imagen)) {
                ...
                $sql = "INSERT INTO prendas (nombre, precio, detalles, stock, imagen, tipo) VALUES ('$nombre', $precio, '$detalles', $stock, '$imagen', '$tipoa')";
