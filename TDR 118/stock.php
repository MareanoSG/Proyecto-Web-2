...
<head>
    ...
    <link rel="stylesheet" href="CSS/styStock.css">
...
<body>
    ...
    <section class="contStock">
        ...
        <?php
            ...
            $sql = "SELECT id_prenda, imagen, nombre, stock FROM prendas";
                ...
                while ($datos = mysqli_fetch_array($ejecutar)) {
                    ...
                    <article class="cajaStock">
                        ...
                        <div class="prendaStockInfo">
                            <a href="producto.php?userid=6&prodid=<?php echo $datos['id_prenda']?>"><?php echo $datos['nombre']; ?></a>
                        </div>
        ...
        <article class="cajaStock">
            <div class="prendaStockTotal" id="totalStock">
                <h2 id="total">Hay <?php echo $totalStock; ?> productos en stock.</h2>
            </div>
        </article>
    </section>
</body>
