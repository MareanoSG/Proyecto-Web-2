...
<body>
   ...
   <section class="casi-slider">
      	...
      	<div class="">Página Principal</div>
        <?php
   ...
   <section class="catalogoGeneral">
    <?php
        ...
        $sql = 'SELECT nombre, precio, imagen, detalles FROM prendas ';
        if($_GET['catalogo'] == '1') $sql = "SELECT nombre, precio, imagen, detalles FROM prendas WHERE tipo = '1'";
        if($_GET['catalogo'] == '2') $sql = "SELECT nombre, precio, imagen, detalles FROM prendas WHERE tipo = '2'";
        if($_GET['catalogo'] == '3') $sql = "SELECT nombre, precio, imagen, detalles FROM prendas WHERE tipo = '3'";
        ...
        if(mysqli_num_rows($ejecutar) > 0) {
            while($datos = mysqli_fetch_array($ejecutar)) {
                ...
                ?>
                <a href="" class="prenda">
                    <div class="imgPrenda" style="background-image: url('<?php echo $imgPrenda; ?>')"></div>
