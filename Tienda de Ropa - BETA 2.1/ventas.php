...
<body>
    ...
    <section class="cajaCompras">
        ...
        $sql = "SELECT compras.id_compra, compras.id_prenda, compras.id_comprador, compras.cantidad, compras.total, compras.fecha, prendas.nombre, prendas.imagen, cuentas.nombre AS nombreUsuario FROM compras JOIN prendas ON compras.id_prenda = prendas.id_prenda JOIN cuentas ON compras.id_comprador = cuentas.user_id WHERE compras.id_compra BETWEEN $min AND $max;";
        $ejecutar = mysqli_query($conn, $sql);
